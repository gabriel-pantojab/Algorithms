...
console.log("Array:",l8);
const res5 = quickSort(l8);
console.log("Array:",res5);
console.log();
...
const l9 = [...randomArray];
console.log("TAIL RECURSION QUICK SORT");
console.log("Array:",l9);
const res6 = tail_recursion_quickSort(l9, 0, l9.length - 1);
console.log("Array:",res6);
console.log();